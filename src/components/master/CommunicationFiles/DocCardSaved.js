        ...
        <Fragment>
            <div className={`card mb-1 py-1 border-left-info ${styles.docrow}`}>
                <div className="row card-body p-1 align-items-center">
                    ...
                    <div className=" row col-sm-9 bg-gray-200 rounded py-1">
                        <div className="col-sm-1 ">
                            ...
                            {props.item.file_type.split('/')[0] !== "image" && <img src={ImageConfig[props.item.file_type.split('/')[1]] || ImageConfig['default']} alt="" width="75px" height="75px" />}
