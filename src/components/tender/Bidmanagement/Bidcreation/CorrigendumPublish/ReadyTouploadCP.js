                ...
                <div className="card-body">
                    <div className="row no-gutters align-items-center">
                        ...
                        <div className="col-md-2 d-flex align-items-center justify-content-center">
                            ...
                            {!preview && <img src={ImageConfig[props.file.type.split('/')[1]] || ImageConfig[props.file.name.split('.').pop()] ||  ImageConfig['default']} alt="" width="75px" height="75px"/>}
...
export default ReadyToUploadCP